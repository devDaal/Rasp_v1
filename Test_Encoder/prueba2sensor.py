...
class SensorTest(Frame):
    ...
    def __init__(self, container):
        ...
        self.selected_btn = Button(self.sensor_setings_container, text='Select Sensor(s)', bg='green',fg='White',
                                   font=("Robot", 16,"bold"), command=self.get_selected_sensor)
        self.selected_btn.grid()
        
        self.wipe_sensor_grid_btn = Button(self.sensor_setings_container, text='Clean grid', bg='gray',fg='White',
                                           font=("Robot", 16,"bold"), command=self.wipe_sensor_grid)
        self.wipe_sensor_grid_btn.grid()
        ...
        self.sensor_test_start_btn.grid(padx=10)
        ...
        self.sensor_test_stop_btn.grid(padx=10)
        ...
        self.pines_labels = {11: self.pin_11_lbl,
                             13: self.pin_13_lbl,
                             15: self.pin_15_lbl,
                             16: self.pin_16_lbl,
                             18: self.pin_18_lbl,
    ...
    def get_selected_sensor(self):
        ...
        values = list(self.pines_labels.values())
        for i in range(self.test_amount_sensor):
            values[i].grid()
    
    def wipe_sensor_grid(self):
        for label in self.pines_labels.values():
            label.grid_remove()
